    ...
    try:
        ...
        if panel_type == "start":
            ...
            from modules.ui_menus import (
                ...
                get_vt_screenshot_menu, get_vt_audioremover_menu, get_vt_hdcover_menu,
            ...
            if prefix == "vt":
                ...
                if action == "open":
                    ...
                    if active == tool:
                        ...
                        if tool == "hdcover":
                            from modules.hd_cover_tool import user_thumbnails
                            if user_id in user_thumbnails:
                                user_thumbnails.pop(user_id)
                                logger.info(f"Cleared HD Cover cache for user {user_id}")
