...
class Database:
    ...
    def get_default_settings(self, user_id: int):
        ...
        return {
            ...
            "metadata": False,
            "mediainfo_enabled": True, # Enable/disable instant mediainfo generation
            ...
            "encode_settings": {
                ...
                "abitrate": "128k",
                "suffix": "[ENC]",
                "auto_framerate": True # Auto-detect and optimize frame rate based on resolution
            },
            ...
            "watermark_settings": {
                ...
                "opacity": 0.7,
                "frequency": "full" # '1', '3', '5', '10', 'full' - how many times watermark appears in video
            },
            
            # (Granular Settings Dictionary)
            "sample_settings": {
                "duration": 30, # in seconds
                "from_point": "random" # 'random', 'start', 'middle', 'end'
            },
